...
<x-dashboard.page-header
    ...
    :actions="'<a href=\'' . route('admin/neracasaldo/exportexcel', ['periode_id' => $periode->id]) . '?month=' . request()->query('month') . '\' class=\'btn-success btn-sm\'><i data-lucide=\'file-spreadsheet\' class=\'w-4 h-4\'></i> Export Excel</a>'"
/>
