...
@section('title', 'Pengaturan - Tambah')
@section('content')

<x-dashboard.page-header
  title="Tambah Otorisator"
  description="Buat otorisator transaksi baru"
  :actions="'<a href=\"' . route('admin/otorisator/home') . '\" class=\"btn-secondary\"><i data-lucide=\"arrow-left\" class=\"w-4 h-4\"></i> Kembali</a>'"
/>

<div class="card">
  <div class="card-body">
    <form action="{{ route('admin/otorisator/save') }}" method="POST">
      @csrf
      <div class="mb-4">
