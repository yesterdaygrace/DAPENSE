...
<x-dashboard.page-header
    ...
    :actions="'<a href=\'' . route('admin/saldoawal/create') . '\' class=\'btn-primary\'>Tambah Saldo Awal</a>'"
/>

<div class="filter-card mb-6">
  <div class="card-body">
    <form method="GET" action="{{ route('admin/saldoawal') }}">
...
<div class="card">
  ...
  <div class="card-body p-6">
    ...
    <x-dashboard.empty-state
        ...
        :action="'<a href=\'' . route('admin/saldoawal/create') . '\' class=\'btn-primary btn-sm\'>Tambah Saldo Awal</a>'"
    />
    @else
          ...
          <tr class="hover:bg-gray-50/50 transition-colors">
            ...
            <td>
              <div class="flex items-center gap-2">
                <a href="{{ route('admin.saldoawal.edit', $saldo_awal->id) }}" class="btn-warning btn-sm">Edit</a>
                <button type="button" class="btn-danger btn-sm" onclick="window.dispatchEvent(new CustomEvent('delete-modal-open', {detail: '{{ route('admin.saldoawal.destroy', $saldo_awal->id) }}'}))">Hapus</button>
              </div>
            </td>
          </tr>
          @endforeach
