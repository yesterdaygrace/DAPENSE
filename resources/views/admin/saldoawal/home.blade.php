...
@section('content')
@include('components.admin-sidebar', ['activeMenu' => 'saldoawal'])
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <div class="container mt-5">
                    ...
                    <form method="GET" action="{{ route('admin/saldoawal') }}" class="mb-3">
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <a href="{{ route('admin/saldoawal/create') }}" class="mb-3 btn btn-primary">Tambah Saldo Awal</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('admin.saldoawal.edit', $saldo_awal->id) }}" class="btn btn-warning btn-sm me-2">Edit</a>
                                        <form action="{{ route('admin.saldoawal.destroy', $saldo_awal->id) }}" method="POST" style="display: inline-block; margin: 0;" id="deleteForm{{ $saldo_awal->id }}">
                                            @csrf
                                            @method('DELETE')
                                            @php
                                            $deleteUrl = route('admin.saldoawal.destroy', $saldo_awal->id);
                                            @endphp
