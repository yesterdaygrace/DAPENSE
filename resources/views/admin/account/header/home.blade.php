  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('admin/account/header/create') }}" class="btn btn-primary">Tambah Header COA</a>
      </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="align-middle">
                <a href="{{ route('admin/account/header/edit', $headerCoa->id) }}" type="button" class="btn btn-warning">Edit</a>
                <button type="button" class="btn btn-danger" onclick="confirmDelete('{{ route('admin/account/header/delete', $headerCoa->id) }}')">Hapus</button>
              </td>
            </tr>
            @empty
            <tr>
