      ...
      <div class="text-gray-900 card-body">
        ...
        <form action="{{ route('admin/periodes/update', $periode->id) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" id="nama_periode" name="nama_periode" class="form-control @error('nama_periode') is-invalid @enderror" placeholder="Masukkan nama periode" value="{{ $periode->nama_periode }}">
            @error('nama_periode')
