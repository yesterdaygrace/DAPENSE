    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('admin/bukubesar') }}" class="mb-3 btn btn-primary">Go Back</a>
                <h2>Buku Besar</h2>

                <!-- Form for selecting period -->
                <form action="{{ route('admin/bukubesar/searchCoaByFilter') }}" method="GET" class="mb-3">
                    <div class="row">
                        <div class="col-md-4">
                ...
                <form action="{{ route('admin/bukubesar/searchByDate') }}" method="GET" class="mb-3">
                    @csrf
