...
<x-dashboard.page-header
    ...
    :actions="'<a href=\'' . route('admin/bukubesar') . '\' class=\'btn-secondary btn-sm\'>Go Back</a>'"
/>

<div class="filter-card mb-6">
  <div class="card-body">
    <div class="filter-row">
      <form action="{{ route('admin/bukubesar/searchCoaByFilter') }}" method="GET" class="contents">
      ...
      <form action="{{ route('admin/bukubesar/searchByDate') }}" method="GET" class="contents">
        @csrf
