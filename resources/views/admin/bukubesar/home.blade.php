...
if (isset($entries) && count($entries) > 0 && isset($periodeId) && isset($selectedCoa) && isset($bulan)) {
    $exportUrl = route('admin/bukubesar/export', [
...
<div class="filter-card mb-6">
  <div class="card-body">
    <div class="filter-row">
      <form action="{{ route('admin/bukubesar/searchCoaByPeriod') }}" method="GET" class="contents">
      ...
      <form action="{{ route('admin/bukubesar/showAll') }}" method="GET" class="contents">
        @csrf
