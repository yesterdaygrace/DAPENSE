    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h2>Buku Besar</h2>
                <!-- <a href="{{ route('bod/bukubesar/filter') }}" class="mb-3 btn btn-primary">Go to Filter Data</a> -->

                <!-- Form for selecting period -->
                <form action="{{ route('bod/bukubesar/searchCoaByPeriod') }}" method="GET" class="mb-3">
                    <div class="row">
                        <div class="col-md-4">
                ...
                <form action="{{ route('bod/bukubesar/showAll') }}" method="GET">
                    @csrf
                ...
                <div class="mb-3 text-end">
                    <a href="{{ route('bod/bukubesar/export', [
