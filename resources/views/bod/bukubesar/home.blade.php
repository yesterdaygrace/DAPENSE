...
if (isset($entries) && count($entries) > 0 && isset($periodeId) && isset($selectedCoa) && isset($bulan)) {
    $exportUrl = route('bod/bukubesar/export', [
...
<div class="filter-card mb-6">
  <div class="card-body">
    <div class="filter-row">
      <form action="{{ route('bod/bukubesar/searchCoaByPeriod') }}" method="GET" class="contents">
      ...
      <form action="{{ route('bod/bukubesar/showAll') }}" method="GET" class="contents">
        @csrf
