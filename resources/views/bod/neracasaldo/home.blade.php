...
<x-dashboard.page-header
    ...
    :actions="'<a href=\'' . route('bod/neracasaldo/exportexcel', ['periode_id' => $periode->id]) . '?month=' . request()->query('month') . '\' class=\'btn-success btn-sm\'><i data-lucide=\'file-spreadsheet\' class=\'w-4 h-4\'></i> Export Excel</a> <a href=\'' . route('bod/neracasaldo/exportpdf', ['periode_id' => $periode->id]) . '?month=' . request()->query('month') . '\' class=\'btn-secondary btn-sm\'><i data-lucide=\'file-text\' class=\'w-4 h-4\'></i> Export PDF</a>'"
/>
