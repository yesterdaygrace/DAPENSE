    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="mt-3 card">
            ...
            <div class="card-body">
                ...
                @endif
                <form id="jurnaling-form" action="{{ route('rootsuperuser/jurnaling/store') }}" method="POST">
                    @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function prepareFormForEdit(dataId) {
            ...
            form.action = `/rootsuperuser/jurnaling/editkm/${dataId}`;
        ...
        function prepareFormForDelete(dataId) {
            form.action = `/rootsuperuser/jurnaling/deletekm/${dataId}`;
        ...
        nomorTransaksiInput.addEventListener('input', function() {
            ...
            if (nomorTransaksi.length > 3) {
                fetch(`/rootsuperuser/jurnaling/cek-nomor-buktikm?nomor_transaksi=${nomorTransaksi}&tanggal_jurnal=${tanggalJurnal}`)
                    ...
                    .then(data => {
                        if (data.exists) {
                            ...
                            const nomorBukti = `KM-${str_pad(nomorTransaksi, 4, '0', 'left')}/${bulan}/${tahun}`;
    ...
    `;
        ...
        function updateNomorBukti() {
            ...
            nomorBuktiInput.value = `KM-${nomorTransaksi}/${bulan}/${tahun}`;
