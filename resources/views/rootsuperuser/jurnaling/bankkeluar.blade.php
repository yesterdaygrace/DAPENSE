...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function prepareFormForEdit(dataId) {
            ...
            form.action = `/rootsuperuser/jurnaling/editbk/${dataId}`;
        ...
        function prepareFormForDelete(dataId) {
            form.action = `/rootsuperuser/jurnaling/deletebk/${dataId}`;
        ...
        nomorTransaksiInput.addEventListener('input', function() {
            ...
            if (nomorTransaksi.length > 3 && nomorAkun.length === 4) {
                fetch(`/rootsuperuser/jurnaling/cek-nomor-buktibk?nomor_transaksi=${nomorTransaksi}&nomor_akun=${nomorAkun}&tanggal_jurnal=${tanggalJurnal}`)
