...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function prepareFormForEdit(dataId) {
            ...
            form.action = `/rootsuperuser/jurnaling/editmempenutup/${dataId}`;
        ...
        function prepareFormForDelete(dataId) {
            form.action = `/rootsuperuser/jurnaling/deletemempenutup/${dataId}`;
        ...
        nomorTransaksiInput.addEventListener('input', function() {
            ...
            if (nomorTransaksi.length > 3) {
                fetch(`/rootsuperuser/jurnaling/cek-nomor-buktimempenutup?nomor_transaksi=${nomorTransaksi}&tanggal_jurnal=${tanggalJurnal}`)
