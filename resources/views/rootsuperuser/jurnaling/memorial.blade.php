    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="mt-3 card">
            ...
            <div class="card-body">
                ...
                @endif
                <form id="jurnaling-form" action="{{ route('rootsuperuser/jurnaling/storememorial') }}" method="POST">
                    @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function prepareFormForEdit(dataId) {
            ...
            form.action = `/rootsuperuser/jurnaling/editmem/${dataId}`;
        ...
        function prepareFormForDelete(dataId) {
            form.action = `/rootsuperuser/jurnaling/deletemem/${dataId}`;
