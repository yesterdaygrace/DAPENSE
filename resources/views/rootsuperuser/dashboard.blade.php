...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            @php
            $menus = [
            ['name' => 'User Management', 'route' => 'rootsuperuser/products', 'icon' => 'bx bx-user'],
            ['name' => 'Periode', 'route' => 'rootsuperuser/periodes', 'icon' => 'bx bx-calendar'],
            ['name' => 'COA (Charts of Account)', 'route' => 'rootsuperuser/account/coa', 'icon' => 'bx bx-spreadsheet'],
            ['name' => 'Saldo Awal', 'route' => 'rootsuperuser/saldoawal', 'icon' => 'bx bx-money'],
            ['name' => 'Jurnaling', 'route' => 'rootsuperuser/jurnaling', 'icon' => 'bx bx-notepad'],
            ['name' => 'Buku Besar', 'route' => 'rootsuperuser/bukubesar', 'icon' => 'bx bx-book'],
            ['name' => 'Neraca Saldo', 'route' => 'rootsuperuser/neracasaldo/', 'icon' => 'bx bx-calculator'],
            ];
            @endphp
