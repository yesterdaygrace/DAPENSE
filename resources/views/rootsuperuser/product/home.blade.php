  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('rootsuperuser/products/create') }}" class="btn btn-primary">Tambah User</a>
      </div>
      <div class="card-body">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="align-middle">
                ...
                <a href="{{ route('rootsuperuser/products/status', $user->id) }}" class="btn btn-{{ $user->status ? 'danger' : 'success' }}">
                  {{ $user->status ? 'Deactivate' : 'Activate' }}
                </a>
                <a href="{{ route('rootsuperuser/products/edit', $user->id) }}" type="button" class="btn btn-warning">Edit</a>
                <button type="button" class="btn btn-danger" onclick="confirmDelete('{{ route('rootsuperuser/products/delete', $user->id) }}')">Hapus</button>
                @endif
              </td>
            </tr>
            @empty
