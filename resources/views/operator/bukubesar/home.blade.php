    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header">
                <h2>Buku Besar</h2>
                <!-- <a href="{{ route('operator/bukubesar/filter') }}" class="mb-3 btn btn-primary">Go to Filter Data</a> -->

                <!-- Form for selecting period -->
                <form action="{{ route('operator/bukubesar/searchCoaByPeriod') }}" method="GET" class="mb-3">
                    <div class="row">
                        <div class="col-md-4">
                ...
                <form action="{{ route('operator/bukubesar/showAll') }}" method="GET">
                    @csrf
