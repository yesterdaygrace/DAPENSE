...
if (isset($entries) && count($entries) > 0 && isset($periodeId) && isset($selectedCoa) && isset($bulan)) {
    $exportUrl = route('operator/bukubesar/export', [
...
<div class="filter-card mb-6">
  <div class="card-body">
    <div class="filter-row">
      <form action="{{ route('operator/bukubesar/searchCoaByPeriod') }}" method="GET" class="contents">
      ...
      <form action="{{ route('operator/bukubesar/showAll') }}" method="GET" class="contents">
        @csrf
