...
<x-dashboard.page-header
    ...
    :actions="'<a href=\'' . route('operator/account/coa') . '\' class=\'btn-secondary\'>Kembali</a>'"
/>
    ...
    <form action="{{ route('operator/account/coa/save') }}" method="POST">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div>
          ...
          <input type="text" id="kode_akun" name="kode_akun" minlength="8" maxlength="8" class="input-field @error('kode_akun') border-danger @enderror input-uppercase" placeholder="Masukkan kode akun" value="{{ old('kode_akun') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
      ...
      <div class="flex items-center gap-3 mt-6">
        ...
        <a href="{{ route('operator/account/coa') }}" class="btn-secondary">Batal</a>
      </div>
    </form>
  </div>
</div>
