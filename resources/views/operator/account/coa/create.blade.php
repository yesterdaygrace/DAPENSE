    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('operator/account/coa/save') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="kode_akun" class="form-label">Kode Akun</label>
                        <input style="text-transform: uppercase;" type="text" id="kode_akun" name="kode_akun" minlength="8" maxlength="8" class="form-control @error('kode_akun') is-invalid @enderror" placeholder="Masukkan kode akun" value="{{ old('kode_akun') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        @error('kode_akun')
                    ...
                    <div class="mb-3">
                        ...
                        <input style="text-transform: uppercase;" type="text" id="nama_akun" name="nama_akun" class="form-control @error('nama_akun') is-invalid @enderror" placeholder="Masukkan nama akun" value="{{ old('nama_akun') }}">
                        @error('nama_akun')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
