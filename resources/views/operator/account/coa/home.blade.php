    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
          ...
          <a href="{{ route('operator/account/coa/create') }}" class="btn btn-primary">Tambah COA</a>
        </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="align-middle">
                  <a href="{{ route('operator/account/coa/edit', $coa->id) }}" type="button" class="btn btn-warning">Edit</a>
                  <button type="button" class="btn btn-danger" onclick="confirmDelete('{{ route('operator/account/coa/delete', $coa->id) }}')">Hapus</button>
                </td>
              </tr>
              @empty
              <tr>
