...
<x-dashboard.page-header
    ...
    :actions="'<a href=\'' . route('operator/jurnaling') . '\' class=\'btn-secondary\'>Kembali</a>'"
/>

<div class="card">
    <div class="card-body">
        <form action="{{ route('operator/jurnaling/save') }}" method="POST" enctype="multipart/form-data">
            @csrf
