...
<x-dashboard.page-header
    title="Jurnal Bank Masuk"
    description="Entri jurnal bank masuk"
/>
...
<div class="card mt-4">
    ...
    <div class="card-body">
        ...
        <form id="jurnaling-form" action="{{ route('operator/jurnaling/storebankmasuk') }}" method="POST">
            @csrf
            ...
            <div id="coa-container">
                <div class="mb-3">
                    ...
                    <div class="flex items-center gap-0">
                        ...
                        <span class="px-3 py-2 border border-x-0 border-gray-300 bg-gray-100 text-sm font-medium">-BM-</span>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function calculateTotals() {
            ...
            document.getElementById('total-debit').textContent = formatNumberValue(totalKredit);
            ...
            if (debitInput) {
                debitInput.value = formatNumberValue(totalKredit);
            }
        ...
        function prepareFormForEdit(dataId) {
            ...
            form.action = `/admin/jurnaling/editbm/${dataId}`;
        ...
        function prepareFormForDelete(dataId) {
            form.action = `/admin/jurnaling/deletebm/${dataId}`;
        ...
        nomorTransaksiInput.addEventListener('input', function() {
            ...
            if (nomorTransaksi.length > 3 && nomorAkun.length === 4) {
                fetch(`/admin/jurnaling/cek-nomor-buktibm?nomor_transaksi=${nomorTransaksi}&nomor_akun=${nomorAkun}&tanggal_jurnal=${tanggalJurnal}`)
