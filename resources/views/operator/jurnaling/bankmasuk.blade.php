...
@section('content')
@include('components.admin-sidebar', ['activeMenu' => 'jurnaling-bankmasuk'])
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function prepareFormForEdit(dataId) {
            ...
            form.action = `/operator/jurnaling/editbm/${dataId}`;
        ...
        function prepareFormForDelete(dataId) {
            form.action = `/operator/jurnaling/deletebm/${dataId}`;
        ...
        nomorTransaksiInput.addEventListener('input', function() {
            ...
            if (nomorTransaksi.length > 3 && nomorAkun.length === 4) {
                fetch(`/operator/jurnaling/cek-nomor-buktibm?nomor_transaksi=${nomorTransaksi}&nomor_akun=${nomorAkun}&tanggal_jurnal=${tanggalJurnal}`)
