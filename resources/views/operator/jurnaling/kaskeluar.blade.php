...
<x-dashboard.page-header
    ...
    description="Entri jurnal kas keluar"
/>
...
<div class="card mt-4">
    ...
    <div class="card-body">
        ...
        <form id="jurnaling-form" action="{{ route('operator/jurnaling/storekaskeluar') }}" method="POST">
            @csrf
            ...
            <div id="coa-container">
                <div class="mb-3">
                    ...
                    <div class="flex items-center gap-0">
                        <span class="px-3 py-2 border border-r-0 border-gray-300 rounded-l bg-gray-100 text-sm font-medium">KK-</span>
                ...
                <div id="first-coa-group" class="flex flex-wrap gap-4 mb-3">
                    ...
                    <div class="flex-1">
                        ...
                        <input type="text" class="input-field debit-input" name="debit[]" value="" required placeholder="Masukkan Debit" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    </div>
                    <div class="hidden">
                ...
                <div id="opposite-coa-group" class="flex flex-wrap gap-4 mt-4">
                    <div class="flex-1">
                        <label for="opposite-coa-id" class="label">Akun Kredit</label>
                        <select class="select-field" id="opposite-coa-id" name="coa_id[]" required>
                            @foreach ($coas as $coa)
                    ...
                    <div class="flex-1">
                        ...
                        <input type="text" class="input-field kredit-input" name="kredit[]" value="" required placeholder="Masukkan Kredit">
                    </div>
                    <div class="hidden">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function prepareFormForEdit(dataId) {
            ...
            form.action = `/admin/jurnaling/editkk/${dataId}`;
        ...
        function prepareFormForDelete(dataId) {
            form.action = `/admin/jurnaling/deletekk/${dataId}`;
        ...
        nomorTransaksiInput.addEventListener('input', function() {
            ...
            if (nomorTransaksi.length > 3) {
                fetch(`/admin/jurnaling/cek-nomor-buktikk?nomor_transaksi=${nomorTransaksi}&tanggal_jurnal=${tanggalJurnal}`)
