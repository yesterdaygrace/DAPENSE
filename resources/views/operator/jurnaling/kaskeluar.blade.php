...
@section('content')
@include('components.admin-sidebar', ['activeMenu' => 'jurnaling-kaskeluar'])
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function prepareFormForEdit(dataId) {
            ...
            form.action = `/operator/jurnaling/editkk/${dataId}`;
        ...
        function prepareFormForDelete(dataId) {
            form.action = `/operator/jurnaling/deletekk/${dataId}`;
        ...
        nomorTransaksiInput.addEventListener('input', function() {
            ...
            if (nomorTransaksi.length > 3) {
                fetch(`/operator/jurnaling/cek-nomor-buktikk?nomor_transaksi=${nomorTransaksi}&tanggal_jurnal=${tanggalJurnal}`)
