...
@section('content')
@include('components.admin-sidebar', ['activeMenu' => 'jurnaling-bankkeluar'])
                    ...
                    <div id="coa-container">
                        <div class="mb-3 row">
                            <div class="col">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" maxlength="4" id="nomor_akun" name="nomor_akun" required placeholder="4 Digit Terakhir Akun"> <span class="input-group-text">-BK-</span>
                        ...
                        <div id="first-coa-group" class="mb-0 row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control debit-input" name="debit[]" value="" required placeholder="Masukkan Debit" oninput="this.value = this.value.replace(/[^0-9]/g, '')" oninput="toggleHiddenInput(this, 'credit')">
                            </div>
                            <div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function prepareFormForEdit(dataId) {
            ...
            form.action = `/operator/jurnaling/editbk/${dataId}`;
        ...
        function prepareFormForDelete(dataId) {
            form.action = `/operator/jurnaling/deletebk/${dataId}`;
        ...
        function updateNomorBukti() {
            const nomorAkun = nomorAkunInput.value; // Mengambil 4 digit terakhir dari nomor akun
        ...
        nomorTransaksiInput.addEventListener('input', function() {
            ...
            if (nomorTransaksi.length > 3 && nomorAkun.length === 4) {
                fetch(`/operator/jurnaling/cek-nomor-buktibk?nomor_transaksi=${nomorTransaksi}&nomor_akun=${nomorAkun}&tanggal_jurnal=${tanggalJurnal}`)
