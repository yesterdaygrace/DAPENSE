...
class LaporanPerubahanAsetNeto implements WithTitle, FromCollection, WithHeadings, WithEvents, WithColumnWidths
{
    ...
    public function collection()
    {
        ...
        $asetNetoAwalPeriodeCurrent = \App\Export\operator\LaporanAsetNeto::$asetNeto['last'];
        ...
        $result[] = [
            ...
            'Saldo Akhir (Current)' => $this->formatSaldo(\App\Export\operator\LaporanAsetNeto::$asetNeto['last']),
        ];

        $result[] = [
            'Investasi Nilai Buku' => 'ASET NETO AKHIR PERIODE',
            'Saldo Akhir (Last)' => $this->formatSaldo(\App\Export\operator\LaporanAsetNeto::$asetNeto['last']),
            'Saldo Akhir (Current)' => $this->formatSaldo(\App\Export\operator\LaporanAsetNeto::$asetNeto['current']),
        ];
