...
class LaporanPerubahanAsetNeto implements FromCollection, WithColumnWidths, WithEvents, WithHeadings, WithTitle
{
    ...
    public function collection()
    {
        ...
        $asetNetoAwalPeriodeCurrent = LaporanAsetNeto::$asetNeto['last'];
        ...
        $result[] = [
            ...
            'Saldo Akhir (Current)' => $this->formatSaldo(LaporanAsetNeto::$asetNeto['last']),
        ];

        $result[] = [
            'Investasi Nilai Buku' => 'ASET NETO AKHIR PERIODE',
            'Saldo Akhir (Last)' => $this->formatSaldo(LaporanAsetNeto::$asetNeto['last']),
            'Saldo Akhir (Current)' => $this->formatSaldo(LaporanAsetNeto::$asetNeto['current']),
        ];
