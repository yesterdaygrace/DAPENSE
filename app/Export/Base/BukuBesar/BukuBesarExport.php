...
namespace App\Export\Base\BukuBesar;
...
class BukuBesarExport implements FromCollection, ShouldAutoSize, WithCustomStartCell, WithEvents, WithHeadings, WithMapping, WithTitle
{
    protected $entries;
