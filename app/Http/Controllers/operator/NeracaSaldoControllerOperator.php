...
use App\Export\operator\NeracaSaldoSheet;
use App\Models\COA;
...
class NeracaSaldoControllerOperator
{
    public function index($periode_id)
    {
        ...
        // return view('operator.neracasaldo.home', compact('periode', 'headerCoas'));
    }

    public function indexrecap()
    {
        $periodes = Periode::orderBy('tanggal_awal', 'desc')->get();;
        return view('operator.neracasaldo.recap', compact('periodes'));
    }
    ...
    public function showPerMonthNeraca(Request $request, $periode = null)
    {
        ...
        return view('operator/neracasaldo/monthstampil', [
            'periodes' => $periodes,
    ...
    public function indexmon(Request $request, $periode_id)
    {
        ...
        return view('operator.neracasaldo.home', compact('periode', 'headerCoas', 'month'));
    }
