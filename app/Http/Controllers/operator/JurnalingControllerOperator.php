...
use App\Export\operator\Jurnaling\JurnalingSheet;
use Maatwebsite\Excel\Facades\Excel;
use Carbon\Carbon;
use DateTime;

class JurnalingControllerOperator
{

    public function create()
    {
        return view('operator.jurnaling.create');
    }
    ...
    public function save(Request $request)
    {
        ...
        return redirect()->route('operator/jurnaling', ['periode_id' => $periode->id])
    ...
    public function index(Request $request)
    {
        ...
        return view('operator.jurnaling.home', [
    ...
    public function indexkaskeluar(Request $request)
    {
        ...
        return view('operator.jurnaling.kaskeluar', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function indexbankmasuk(Request $request)
    {
        ...
        return view('operator.jurnaling.bankmasuk', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function indexbankkeluar(Request $request)
    {
        ...
        return view('operator.jurnaling.bankkeluar', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function indexmemorial(Request $request)
    {
        ...
        return view('operator.jurnaling.memorial', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function indexmemorialpenutup(Request $request)
    {
        ...
        return view('operator.jurnaling.memorialpenutup', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            ...
            'redirect' => route('operator/jurnaling')
        ]);
    }
    ...
    public function storekaskeluar(Request $request)
    {
        ...
        return response()->json([
            'success'  => 'Data berhasil diinputkan!',
            'redirect' => route('operator/jurnaling/kaskeluar')
        ]);
    }
    ...
    public function storebankmasuk(Request $request)
    {
        ...
        return response()->json([
            'success'  => 'Data berhasil diinputkan!',
            'redirect' => route('operator/jurnaling/bankmasuk')
        ]);
    }
    ...
    public function storebankkeluar(Request $request)
    {
        ...
        return response()->json([
            'success'  => 'Data berhasil diinputkan!',
            'redirect' => route('operator/jurnaling/bankkeluar')
        ]);
    }
    ...
    public function storememorial(Request $request)
    {
        ...
        return response()->json([
            'success'  => 'Data berhasil diinputkan!',
            'redirect' => route('operator/jurnaling/memorial')
        ]);
    }
    ...
    public function storememorialpenutup(Request $request)
    {
        ...
        return response()->json([
            'success'  => 'Data berhasil diinputkan!',
            'redirect' => route('operator/jurnaling/memorialpenutup')
        ]);
    }
    ...
    public function updatekm(Request $request, $id)
    {
        ...
        return redirect()->route('operator/jurnaling')
            ->with([
    ...
    public function updatekk(Request $request, $id)
    {
        ...
        return redirect()->route('operator/jurnaling/kaskeluar')
            ->with([
                'selectedPeriode' => $request->periode_id,
                'success' => 'Data berhasil diperbarui!',
            ]);
    ...
    public function updatebm(Request $request, $id)
    {
        ...
        return redirect()->route('operator/jurnaling/bankmasuk')
            ->with([
                'selectedPeriode' => $request->periode_id,
                'success' => 'Data berhasil diperbarui!',
            ]);
    ...
    public function updatebk(Request $request, $id)
    {
        ...
        return redirect()->route('operator/jurnaling/bankkeluar')
            ->with([
                'selectedPeriode' => $request->periode_id,
                'success' => 'Data berhasil diperbarui!',
            ]);
    ...
    public function updatemem(Request $request, $id)
    {
        ...
        return redirect()->route('operator/jurnaling/memorial')
            ->with([
                'selectedPeriode' => $request->periode_id,
                'success' => 'Data berhasil diperbarui!',
            ]);
    ...
    public function updatemempenutup(Request $request, $id)
    {
        ...
        return redirect()->route('operator/jurnaling/memorialpenutup')
            ->with([
                'selectedPeriode' => $request->periode_id,
                'success' => 'Data berhasil diperbarui!',
            ]);
    ...
    public function showPerMonth(Request $request, $periode = null)
    {
        ...
        return view('operator/neracasaldo/months', [
            'periodes' => $periodes,
    ...
    public function showMonths(Request $request, $periode = null)
    {
        ...
        return view('operator/jurnaling/months', compact('periodes', 'selectedPeriode', 'months'));
    }
    ...
    public function rekapJurnalMonth(Request $request, $periode_id)
    {
        ...
        return redirect()->route('operator/neracasaldo/showing', [
            'periode_id' => $periode_id,
    ...
    public function rekapJurnal(Request $request, $periode_id)
    {
        ...
        return redirect()->route('operator/neracasaldo', ['periode_id' => $periode_id])
    ...
    public function showJurnaling(Request $request)
    {
        ...
        return view('operator.jurnaling.showing', [
            'periodes' => $periodes,
            'coas' => $coas,
            'jurnalings' => $jurnalings,
            'selectedPeriode' => $selectedPeriode,
    ...
    public function showEntries(Request $request)
    {
        ...
        if (!$month || !$periodeId) {
            return redirect()->route('operator/jurnaling/months')
        ...
        return view('operator.jurnaling.showing', compact('monthEntries', 'monthName'));
    }
