...
class HeaderControllerOperator
{
    ...
    public function save(Request $request)
    {
        ...
        return redirect()->route('operator/account/header')->with('success', 'Header COA berhasil ditambahkan.');
    }
    ...
    public function updateSave(Request $request, $id)
    {
        ...
        return redirect()->route('operator/account/header')
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('operator/account/header')->with('success', 'Header COA berhasil dihapus.');
    }
}
