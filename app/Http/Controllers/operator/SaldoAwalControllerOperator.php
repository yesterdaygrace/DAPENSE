...
class SaldoAwalControllerOperator
{
    public function index(Request $request)
    {
        ...
        return view('operator.saldoawal.home', compact('saldo_awals', 'periodes'));
    }
    ...
    public function create()
    {
        ...
        $periodes = Periode::orderBy('tanggal_awal', 'desc')
            ->get();
        return view('operator.saldoawal.create', compact('coas', 'periodes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('operator/saldoawal')->with('success', 'Saldo Awal berhasil dibuat.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.saldoawal.edit', compact('saldo_awal', 'coas', 'periodes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('operator/saldoawal')->with('success', 'Saldo Awal berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('operator/saldoawal')->with('success', 'Saldo Awal berhasil dihapus.');
    }
}
