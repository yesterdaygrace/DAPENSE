...
class CoaControllerAdmin
{
    public function index()
    {
        $coas = COA::orderBy('kode_akun', 'asc')->get();

        return view('admin.account.coa.home', compact('coas'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.account.coa.create', compact('headers'));
    }
    ...
    public function save(Request $request)
    {
        ...
        return redirect()->route('admin/account/coa')->with('success', 'COA berhasil ditambahkan.');
    }
    ...
    public function update($id)
    {
        ...
        $headers = HeaderCOA::where('level', 3)->orderBy('kode_header')->get();
        return view('admin.account.coa.update', compact('coa', 'headers'));
    }
    ...
    public function updateSave(Request $request, $id)
    {
        ...
        return redirect()->route('admin/account/coa')->with('success', 'COA berhasil diubah.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('admin/account/coa')->with('success', 'COA berhasil dihapus.');
    }
}
