...
class HeaderControllerAdmin
{
    ...
    public function updateSave(Request $request, $id)
    {
        ...
        return redirect()->route('admin/account/header')->with('success', 'Header COA updated successfully.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('admin/account/header')->with('success', 'Header COA deleted successfully.');
    }
}
