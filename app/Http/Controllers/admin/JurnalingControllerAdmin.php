...
use App\Export\admin\Jurnaling\JurnalingSheet;
use App\Models\COA;
...
class JurnalingControllerAdmin
{
    public function create()
    {
        return view('admin.jurnaling.create');
    }
    ...
    public function save(Request $request)
    {
        ...
        return redirect()->route('admin/jurnaling', ['periode_id' => $periode->id])
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.jurnaling.home', [
    ...
    public function indexkaskeluar(Request $request)
    {
        ...
        return view('admin.jurnaling.kaskeluar', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function indexbankmasuk(Request $request)
    {
        ...
        return view('admin.jurnaling.bankmasuk', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function indexbankkeluar(Request $request)
    {
        ...
        return view('admin.jurnaling.bankkeluar', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function indexmemorial(Request $request)
    {
        ...
        return view('admin.jurnaling.memorial', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function indexmemorialpenutup(Request $request)
    {
        ...
        return view('admin.jurnaling.memorialpenutup', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            ...
            'redirect' => route('admin/jurnaling'),
        ]);
    }
    ...
    public function storekaskeluar(Request $request)
    {
        ...
        return response()->json([
            'success' => 'Data berhasil diinputkan!',
            'redirect' => route('admin/jurnaling/kaskeluar'),
        ]);
    }
    ...
    public function storebankmasuk(Request $request)
    {
        ...
        return response()->json([
            'success' => 'Data berhasil diinputkan!',
            'redirect' => route('admin/jurnaling/bankmasuk'),
        ]);
    }
    ...
    public function storebankkeluar(Request $request)
    {
        ...
        return response()->json([
            'success' => 'Data berhasil diinputkan!',
            'redirect' => route('admin/jurnaling/bankkeluar'),
        ]);
    }
    ...
    public function storememorial(Request $request)
    {
        ...
        return response()->json([
            'success' => 'Data berhasil diinputkan!',
            'redirect' => route('admin/jurnaling/memorial'),
        ]);
    }
    ...
    public function storememorialpenutup(Request $request)
    {
        ...
        return response()->json([
            'success' => 'Data berhasil diinputkan!',
            'redirect' => route('admin/jurnaling/memorialpenutup'),
        ]);
    }
    ...
    public function updatekm(Request $request, $id)
    {
        ...
        return redirect()->route('admin/jurnaling')
            ->with([
    ...
    public function updatekk(Request $request, $id)
    {
        ...
        return redirect()->route('admin/jurnaling/kaskeluar')
            ->with([
                'selectedPeriode' => $request->periode_id,
                'success' => 'Data berhasil diperbarui!',
            ]);
    ...
    public function updatebm(Request $request, $id)
    {
        ...
        return redirect()->route('admin/jurnaling/bankmasuk')
            ->with([
                'selectedPeriode' => $request->periode_id,
                'success' => 'Data berhasil diperbarui!',
            ]);
    ...
    public function updatebk(Request $request, $id)
    {
        ...
        return redirect()->route('admin/jurnaling/bankkeluar')
            ->with([
                'selectedPeriode' => $request->periode_id,
                'success' => 'Data berhasil diperbarui!',
            ]);
    ...
    public function updatemem(Request $request, $id)
    {
        ...
        return redirect()->route('admin/jurnaling/memorial')
            ->with([
                'selectedPeriode' => $request->periode_id,
                'success' => 'Data berhasil diperbarui!',
            ]);
    ...
    public function updatemempenutup(Request $request, $id)
    {
        ...
        return redirect()->route('admin/jurnaling/memorialpenutup')
            ->with([
                'selectedPeriode' => $request->periode_id,
                'success' => 'Data berhasil diperbarui!',
            ]);
    ...
    public function showPerMonth(Request $request, $periode = null)
    {
        ...
        return view('admin/neracasaldo/months', [
            'periodes' => $periodes,
    ...
    public function showMonths(Request $request, $periode = null)
    {
        ...
        return view('admin/jurnaling/months', compact('periodes', 'selectedPeriode', 'months'));
    }
    ...
    public function rekapJurnalMonth(Request $request, $periode_id)
    {
        ...
        return redirect()->route('admin/neracasaldo/showing', [
            'periode_id' => $periode_id,
    ...
    public function rekapJurnal(Request $request, $periode_id)
    {
        ...
        return redirect()->route('admin/neracasaldo', ['periode_id' => $periode_id])
    ...
    public function showJurnaling(Request $request)
    {
        ...
        return view('admin.jurnaling.showing', [
            'periodes' => $periodes,
            'coas' => $coas,
            'jurnalings' => $jurnalings,
            'selectedPeriode' => $selectedPeriode,
    ...
    public function showEntries(Request $request)
    {
        ...
        if (! $month || ! $periodeId) {
            return redirect()->route('admin/jurnaling/months')
        ...
        return view('admin.jurnaling.showing', compact('monthEntries', 'monthName'));
    }
