...
class BukuBesarControllerAdmin
{
    ...
    public function filterView()
    {
        ...
        return view('admin.bukubesar.filter', compact('periodes', 'coas'));
    }
    ...
    public function searchCoaByPeriod(Request $request)
    {
        ...
        return view('admin.bukubesar.home', compact('coas', 'periodes', 'periodeId', 'availableMonths'));
    }
    ...
    public function searchCoaByFilter(Request $request)
    {
        ...
        return view('admin.bukubesar.filter', compact('coas', 'periodes', 'periodeId'));
    }
    ...
    public function searchByDate(Request $request)
    {
        ...
        return view('admin.bukubesar.filter', compact(
            'saldoAwal',
            'coas',
            'selectedCoa',
            'periodes',
    ...
    public function showLedger(Request $request)
    {
        ...
        return view('admin.bukubesar.home', compact('coas', 'entries', 'selectedCoa', 'bulan'));
    }
    ...
    public function showAll(Request $request)
    {
        ...
        return view('admin.bukubesar.home', compact('coas', 'entries', 'selectedCoa', 'periodes', 'periodeId', 'bulan', 'availableMonths', 'runningTotal'))
