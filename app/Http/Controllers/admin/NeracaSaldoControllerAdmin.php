...
use App\Export\admin\NeracaSaldoSheet;
use App\Models\COA;
...
class NeracaSaldoControllerAdmin
{
    public function index($periode_id)
    {
        ...
        // return view('admin.neracasaldo.home', compact('periode', 'headerCoas'));
    }
    ...
    public function showPerMonthNeraca(Request $request, $periode = null)
    {
        ...
        return view('admin/neracasaldo/monthstampil', [
            'periodes' => $periodes,
    ...
    public function indexmon(Request $request, $periode_id)
    {
        ...
        return view('admin.neracasaldo.home', compact('periode', 'headerCoas', 'month'));
    }
