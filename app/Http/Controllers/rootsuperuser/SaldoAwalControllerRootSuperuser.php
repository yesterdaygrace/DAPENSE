...
class SaldoAwalControllerRootSuperuser
{
    public function index(Request $request)
    {
        ...
        return view('rootsuperuser.saldoawal.home', compact('saldo_awals', 'periodes'));
    }
    ...
    public function create()
    {
        ...
        $periodes = Periode::orderBy('tanggal_awal', 'desc')
            ->get();
        return view('rootsuperuser.saldoawal.create', compact('coas', 'periodes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('rootsuperuser/saldoawal')->with('success', 'Saldo Awal berhasil dibuat.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('rootsuperuser.saldoawal.edit', compact('saldo_awal', 'coas', 'periodes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('rootsuperuser/saldoawal')->with('success', 'Saldo Awal berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('rootsuperuser/saldoawal')->with('success', 'Saldo Awal berhasil dihapus.');
    }
}
