...
class JurnalingControllerRootSuperuser
{

    public function create()
    {
        return view('rootsuperuser.jurnaling.create');
    }
    ...
    public function save(Request $request)
    {
        ...
        return redirect()->route('rootsuperuser/jurnaling', ['periode_id' => $periode->id])
    ...
    public function index(Request $request)
    {
        ...
        return view('rootsuperuser.jurnaling.home', [
    ...
    public function indexkaskeluar(Request $request)
    {
        ...
        return view('rootsuperuser.jurnaling.kaskeluar', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function indexbankmasuk(Request $request)
    {
        ...
        return view('rootsuperuser.jurnaling.bankmasuk', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function indexbankkeluar(Request $request)
    {
        ...
        return view('rootsuperuser.jurnaling.bankkeluar', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function indexmemorial(Request $request)
    {
        ...
        return view('rootsuperuser.jurnaling.memorial', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function indexmemorialpenutup(Request $request)
    {
        ...
        return view('rootsuperuser.jurnaling.memorialpenutup', [
            'jurnalings' => $jurnalings,
            'coas' => $coas,
            'periodes' => $periodes,
            'sortField' => $request->query('sortField', 'tanggal_jurnal'),
    ...
    public function showPerMonth(Request $request, $periode = null)
    {
        ...
        return view('rootsuperuser/neracasaldo/months', [
            'periodes' => $periodes,
    ...
    public function showMonths(Request $request, $periode = null)
    {
        ...
        return view('rootsuperuser/jurnaling/months', compact('periodes', 'selectedPeriode', 'months'));
    }
    ...
    public function rekapJurnalMonth(Request $request, $periode_id)
    {
        ...
        return redirect()->route('rootsuperuser/neracasaldo/showing', [
            'periode_id' => $periode_id,
    ...
    public function rekapJurnal(Request $request, $periode_id)
    {
        ...
        return redirect()->route('rootsuperuser/neracasaldo', ['periode_id' => $periode_id])
    ...
    public function showJurnaling(Request $request)
    {
        ...
        return view('rootsuperuser.jurnaling.showing', [
            'periodes' => $periodes,
            'coas' => $coas,
            'jurnalings' => $jurnalings,
            'selectedPeriode' => $selectedPeriode,
