...
use App\Export\bod\NeracaSaldoSheet;
use App\Models\COA;
...
class NeracaSaldoControllerBOD
{
    public function index($periode_id)
    {
        ...
        // return view('bod.neracasaldo.home', compact('periode', 'headerCoas'));
    }

    public function indexrecap()
    {
        $periodes = Periode::orderBy('tanggal_awal', 'desc')->get();;
        return view('bod.neracasaldo.recap', compact('periodes'));
    }
    ...
    public function showPerMonthNeraca(Request $request, $periode = null)
    {
        ...
        return view('bod/neracasaldo/monthstampil', [
            'periodes' => $periodes,
    ...
    public function indexmon(Request $request, $periode_id)
    {
        ...
        return view('bod.neracasaldo.home', compact('periode', 'headerCoas', 'month'));
    }
