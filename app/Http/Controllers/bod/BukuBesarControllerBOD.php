...
class BukuBesarControllerBOD
{
    ...
    public function searchCoaByPeriod(Request $request)
    {
        ...
        return view('bod.bukubesar.home', compact('coas', 'periodes', 'periodeId', 'availableMonths'));
    }
    ...
    public function searchCoaByFilter(Request $request)
    {
        ...
        return view('bod.bukubesar.filter', compact('coas', 'periodes', 'periodeId'));
    }
    ...
    public function searchByDate(Request $request)
    {
        ...
        return view('bod.bukubesar.filter', compact(
            'saldoAwal',
            'coas',
            'selectedCoa',
            'periodes',
